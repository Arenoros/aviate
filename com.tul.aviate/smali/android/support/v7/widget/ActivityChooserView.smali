...
.field private final d:Landroid/support/v7/widget/ap;
...
.field private m:Landroid/support/v7/widget/ar;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 213
    sget-object v0, Landroid/support/v7/b/a$k;->ActivityChooserView:[I
    ...
    .line 216
    sget v1, Landroid/support/v7/b/a$k;->ActivityChooserView_initialActivityCount:I
    ...
    .line 220
    sget v1, Landroid/support/v7/b/a$k;->ActivityChooserView_expandActivityOverflowButtonDrawable:I
    ...
    .line 226
    sget v2, Landroid/support/v7/b/a$h;->abc_activity_chooser_view:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->d:Landroid/support/v7/widget/ap;

    .line 231
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->d:Landroid/support/v7/widget/ap;

    invoke-virtual {v0}, Landroid/support/v7/widget/ap;->getBackground()Landroid/graphics/drawable/Drawable;
...
.method private a(I)V
    ...
    .line 366
    :goto_2
    invoke-direct {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/ar;
    ...
    .line 374
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ar;->f(I)V

    .line 375
    invoke-virtual {v3}, Landroid/support/v7/widget/ar;->c()V
    ...
    .line 379
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/ar;->m()Landroid/widget/ListView;
...
.method static synthetic b(Landroid/support/v7/widget/ActivityChooserView;)Landroid/support/v7/widget/ar;
    .locals 1
...
.method private d()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ap;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method private getListPopupWindow()Landroid/support/v7/widget/ar;
    .locals 2

    .prologue
    .line 503
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Landroid/support/v7/widget/ar;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Landroid/support/v7/widget/ar;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/ar;->a(Landroid/view/View;)V
...
.method public setActivityChooserModel(Landroid/support/v7/widget/e;)V
    .locals 1
    .param p1, "dataModel"    # Landroid/support/v7/widget/e;
...
.method public setProvider(Landroid/support/v4/view/d;)V
    .locals 0
    .param p1, "provider"    # Landroid/support/v4/view/d;
