...
.method private a(Landroid/support/v7/widget/RecyclerView;)I
    ...
    sget v1, Landroid/support/v7/f/a$a;->item_touch_helper_max_drag_scroll_per_frame:I
...
.method private a(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;Ljava/util/List;IFF)V
    ...
    .line 1948
    invoke-virtual {v0}, Landroid/support/v7/widget/a/a$b;->c()V
    ...
    .line 1950
    iget-object v3, v0, Landroid/support/v7/widget/a/a$b;->h:Landroid/support/v7/widget/RecyclerView$u;

    iget v4, v0, Landroid/support/v7/widget/a/a$b;->k:F

    iget v5, v0, Landroid/support/v7/widget/a/a$b;->l:F

    iget v6, v0, Landroid/support/v7/widget/a/a$b;->i:I
    ...
    invoke-virtual/range {v0 .. v7}, Landroid/support/v7/widget/a/a$a;->a(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;FFIZ)V
...
.method static synthetic a(Landroid/support/v7/widget/a/a$a;Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;Ljava/util/List;IFF)V
    .locals 0

    .prologue
    .line 1356
    invoke-direct/range {p0 .. p7}, Landroid/support/v7/widget/a/a$a;->b(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;Ljava/util/List;IFF)V
...
.method private b(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;Ljava/util/List;IFF)V
    ...
    invoke-virtual/range {v0 .. v7}, Landroid/support/v7/widget/a/a$a;->b(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;FFIZ)V
    ...
    iget-boolean v3, v0, Landroid/support/v7/widget/a/a$b;->j:Z
...
.method static synthetic b(Landroid/support/v7/widget/a/a$a;Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;Ljava/util/List;IFF)V
    .locals 0

    .prologue
    .line 1356
    invoke-direct/range {p0 .. p7}, Landroid/support/v7/widget/a/a$a;->a(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;Ljava/util/List;IFF)V
...
.method public a(Landroid/support/v7/widget/RecyclerView$u;Ljava/util/List;II)Landroid/support/v7/widget/RecyclerView$u;
    ...
    iget-object v10, v0, Landroid/support/v7/widget/RecyclerView$u;->itemView:Landroid/view/View;

    invoke-virtual {v10}, Landroid/view/View;->getRight()I

    move-result v10

    iget-object v11, p1, Landroid/support/v7/widget/RecyclerView$u;->itemView:Landroid/view/View;
...
.method public a(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;FFIZ)V
    ...
    iget-object v3, p3, Landroid/support/v7/widget/RecyclerView$u;->itemView:Landroid/view/View;
...
.method public a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;ILandroid/support/v7/widget/RecyclerView$u;III)V
    ...
    .line 1912
    instance-of v1, v0, Landroid/support/v7/widget/a/a$c;
    ...
    iget-object v2, p4, Landroid/support/v7/widget/RecyclerView$u;->itemView:Landroid/view/View;

    invoke-interface {v0, v1, v2, p6, p7}, Landroid/support/v7/widget/a/a$c;->a(Landroid/view/View;Landroid/view/View;II)V
    ...
    .line 1920
    iget-object v1, p4, Landroid/support/v7/widget/RecyclerView$u;->itemView:Landroid/view/View;
...
.method public c(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;)V
    .locals 2
