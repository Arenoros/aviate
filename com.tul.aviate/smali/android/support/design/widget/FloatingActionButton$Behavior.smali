...
# instance fields
.field private b:Landroid/support/design/widget/r;
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .line 506
    invoke-static {p1, p2, v0}, Landroid/support/design/widget/u;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method private c(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;Landroid/view/View;)V
    ...
    .line 526
    :cond_0
    invoke-static {p2}, Landroid/support/v4/view/ak;->o(Landroid/view/View;)F

    move-result v1

    .line 529
    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/r;

    if-eqz v2, :cond_1

    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/r;

    invoke-virtual {v2}, Landroid/support/design/widget/r;->b()Z
    ...
    invoke-virtual {v2}, Landroid/support/design/widget/r;->e()V
    ...
    iput-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/r;
    ...
    invoke-virtual {v2, v1, v0}, Landroid/support/design/widget/r;->a(FF)V

    .line 551
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/r;

    invoke-virtual {v1}, Landroid/support/design/widget/r;->a()V
    ...
    .line 554
    :cond_3
    invoke-static {p2, v0}, Landroid/support/v4/view/ak;->b(Landroid/view/View;F)V
