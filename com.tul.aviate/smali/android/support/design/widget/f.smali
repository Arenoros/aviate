...
.method constructor <init>(Landroid/support/design/widget/aa;Landroid/support/design/widget/n;)V
    ...
    .line 44
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/h;-><init>(Landroid/support/design/widget/aa;Landroid/support/design/widget/n;)V

    .line 46
    invoke-virtual {p1}, Landroid/support/design/widget/aa;->getResources()Landroid/content/res/Resources;
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/f;->b:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/f;->c:Landroid/graphics/drawable/Drawable;
    ...
    .line 82
    invoke-virtual {p0, p4, p1}, Landroid/support/design/widget/f;->a(ILandroid/content/res/ColorStateList;)Landroid/support/design/widget/b;

    move-result-object v0

    iput-object v0, p0, Landroid/support/design/widget/f;->d:Landroid/support/design/widget/b;
    ...
    iget-object v1, p0, Landroid/support/design/widget/f;->d:Landroid/support/design/widget/b;

    aput-object v1, v0, v7

    iget-object v1, p0, Landroid/support/design/widget/f;->b:Landroid/graphics/drawable/Drawable;

    aput-object v1, v0, v2

    iget-object v1, p0, Landroid/support/design/widget/f;->c:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Landroid/support/design/widget/f;->e:Landroid/graphics/drawable/Drawable;

    .line 91
    new-instance v0, Landroid/support/design/widget/m;

    iget-object v1, p0, Landroid/support/design/widget/f;->k:Landroid/support/design/widget/aa;

    invoke-virtual {v1}, Landroid/support/design/widget/aa;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    iget-object v2, p0, Landroid/support/design/widget/f;->e:Landroid/graphics/drawable/Drawable;

    iget-object v3, p0, Landroid/support/design/widget/f;->l:Landroid/support/design/widget/n;
    ...
    iget v5, p0, Landroid/support/design/widget/f;->f:F
    ...
    .line 98
    iget-object v0, p0, Landroid/support/design/widget/f;->l:Landroid/support/design/widget/n;
...
.method a(Landroid/support/design/widget/h$a;Z)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/f;->k:Landroid/support/design/widget/aa;
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/aa;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {v1, v0}, Landroid/support/design/widget/aa;->startAnimation(Landroid/view/animation/Animation;)V
...
.method b(F)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/m;->c(F)V
...
.method b(Landroid/support/design/widget/h$a;Z)V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/aa;->clearAnimation()V
