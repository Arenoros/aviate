...
.method constructor <init>(Landroid/support/design/widget/aa;Landroid/support/design/widget/n;)V
    ...
    .prologue
    .line 44
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/g;-><init>(Landroid/support/design/widget/aa;Landroid/support/design/widget/n;)V

    .line 46
    invoke-virtual {p1}, Landroid/support/design/widget/aa;->isInEditMode()Z
    ...
    .line 46
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/i;->k:Landroid/support/design/widget/aa;
...
.method private a(Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    .prologue
    .line 150
    iget-object v0, p0, Landroid/support/design/widget/i;->m:Landroid/view/animation/Interpolator;
...
.method public a()F
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/aa;->getElevation()F
...
.method public a(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/aa;->setElevation(F)V
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/i;->d:Landroid/support/design/widget/b;
    ...
    iget-object v3, p0, Landroid/support/design/widget/i;->d:Landroid/support/design/widget/b;

    aput-object v3, v1, v2

    const/4 v2, 0x1

    iget-object v3, p0, Landroid/support/design/widget/i;->b:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Landroid/support/design/widget/i;->c:Landroid/graphics/drawable/Drawable;
    ...
    .line 66
    :cond_1
    iput-object v4, p0, Landroid/support/design/widget/i;->d:Landroid/support/design/widget/b;
...
.method b(F)V
    ...
    iget-object v2, p0, Landroid/support/design/widget/i;->k:Landroid/support/design/widget/aa;
    ...
    .line 106
    iget-object v1, p0, Landroid/support/design/widget/i;->k:Landroid/support/design/widget/aa;

    invoke-virtual {v1, v0}, Landroid/support/design/widget/aa;->setStateListAnimator(Landroid/animation/StateListAnimator;)V
